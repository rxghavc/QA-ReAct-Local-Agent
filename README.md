...
This README covers what the project is: architecture, tech stack, current measured behavior, and what the engineering process actually found. For the detailed build history (what was tried, what failed, what changed as a result), see [`docs/milestones/`](docs/milestones/). For day-to-day status ("what's done, what's next"), see `CLAUDE.md`.
